...
import { formatCurrency as formatFrenchCurrency, formatDate } from "@/lib/formatters"
...
export type AnalyticsChartSwitcherProps = {
...
function formatMonth(value: string) {
  ...
  return formatDate(date, { month: "short", year: "2-digit", timeZone: "UTC" })
}
